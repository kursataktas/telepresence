...
type ManagerClient interface {
	...
	EnsureAgent(ctx context.Context, in *EnsureAgentRequest, opts ...grpc.CallOption) (*AgentInfo, error)
...
func (c *managerClient) EnsureAgent(ctx context.Context, in *EnsureAgentRequest, opts ...grpc.CallOption) (*AgentInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AgentInfo)
...
type ManagerServer interface {
	...
	// EnsureAgent ensures that an agent is injected to the pods of a workload
	EnsureAgent(context.Context, *EnsureAgentRequest) (*AgentInfo, error)
	// Request that the traffic-manager makes the preparations necessary to
	// create the given intercept.
...
func (UnimplementedManagerServer) EnsureAgent(context.Context, *EnsureAgentRequest) (*AgentInfo, error) {
