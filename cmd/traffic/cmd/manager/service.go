...
func (s *service) EnsureAgent(ctx context.Context, request *rpc.EnsureAgentRequest) (*rpc.AgentInfo, error) {
	...
	ai, err := s.state.EnsureAgent(ctx, request.Name, client.Namespace)
	if err != nil {
